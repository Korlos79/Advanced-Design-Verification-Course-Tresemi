...
class mux_env #(type REQ = uvm_sequence_item, type RSP = uvm_sequence_item) extends uvm_env;
  ...
  function void connect_phase(uvm_phase phase);
    ...
    // an analysis port
    mux_in_agent_0.ref_port.connect(sb.ref_ap_fifo.analysis_export);
    mux_out_agent_0.act_port.connect(sb.act_ap_fifo.analysis_export);
    mux_in_agent_0.cov_port.connect(cov.cov_imp);
  endfunction
